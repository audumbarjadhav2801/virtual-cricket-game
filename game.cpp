...
bool Game::validateInningsScore() {
	...
	if (isFirstInnings) {
        ...
        if (battingTeam->wicketsLost == playersPerTeam || bowlingTeam->totalBallsBowled == maxBalls) {
            ...
            cout << "========================================" << endl;
            cout << "Team-A: " << teamA.totalRunsScored << "/" << teamA.wicketsLost << endl;
            cout << "Team-B: " << teamB.totalRunsScored << "/" << teamB.wicketsLost << endl;
            cout << "========================================" << endl;
            
            if (teamA.totalRunsScored > teamB.totalRunsScored) {
                cout << " Team-A WINS THE MATCH! " << endl;
            } else if (teamB.totalRunsScored > teamA.totalRunsScored) {
                cout << " Team-B WINS THE MATCH! " << endl;
            } else {
